...
let project = "Feliz.SweetAlert"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Fable bindings written in the Feliz-style for sweetalert2"

// Author(s) of the project
let author = "Cody Johnson"

// File system information
let solutionFile = "Feliz.SweetAlert.sln"

// Github repo
let repo = "https://github.com/Shmew/Feliz.SweetAlert"

// Files to skip Fantomas formatting
let excludeFantomas =
    [ __SOURCE_DIRECTORY__ @@ "src/Feliz.SweetAlert/Types.fs"
      __SOURCE_DIRECTORY__ @@ "src/Feliz.SweetAlert/Interop.fs"
      __SOURCE_DIRECTORY__ @@ "src/Feliz.SweetAlert/SweetAlert.fs" ]

// Files that have bindings to other languages where name linting needs to be more relaxed.
let relaxedNameLinting = 
    [ __SOURCE_DIRECTORY__ @@ "src/Feliz.SweetAlert/**/*.fs"
      __SOURCE_DIRECTORY__ @@ "src/Feliz.SweetAlert/*.fs" ]
...
Target.create "CopyDocFiles" <| fun _ ->
    [ pub @@ "SweetAlert/README.md", __SOURCE_DIRECTORY__ @@ "README.md"
      pub @@ "SweetAlert/RELEASE_NOTES.md", __SOURCE_DIRECTORY__ @@ "RELEASE_NOTES.md"
...
Target.create "PackageJson" <| fun _ ->
    let setValues (current: Json.JsonPackage) =
        { current with
            ...
            Bugs = 
                { Json.BugsValue.Url = 
                    @"https://github.com/Shmew/Feliz.SweetAlert/issues/new/choose" |> Some } |> Some
            License = "MIT" |> Some
            Author = author |> Some
            Private = true |> Some }
